<template>
  <div class="app-container">
    <el-card class="box-card" :body-style="{ padding: '0px' }">
      ...
      <el-upload class="upload-demo" drag action="" :limit="1" :http-request="uploadFile" accept=".xls,.xlsx"
    ...
    <el-card v-show="visible" class="box-card">
      ...
      <el-table id="excel" :data="analysisResults" height="290" border style="width: 100%">
        ...
        <el-table-column prop="result" label="情感分析结果" width="480" />
      </el-table>
    </el-card>
  </div>
</template>
...
.app-container::after {
  content: "";
  background: no-repeat url("./bdfvdf.png");
